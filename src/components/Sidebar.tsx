...
export default function Sidebar({ 
  ...
  return (
    <div className={`
      ...
      border-r flex-col items-center py-6 space-y-6
    `}>
      ...
      <div className="relative group cursor-pointer">
        <img
          ...
          className="w-12 h-12 xl:w-14 xl:h-14 rounded-xl object-cover ring-3 cursor-pointer transition-transform hover:scale-105"
          style={{ ringColor: colors.primary }}
        />
        <div className={`absolute -bottom-0.5 -right-0.5 w-5 h-5 ${statusColors[currentUser.status]} rounded-full border-2 ${isDarkMode ? 'border-gray-900' : 'border-white'} flex items-center justify-center`}>
      ...
      >
        ...
        {unreadNotificationCount > 0 && (
          <span 
            className="absolute -top-0.5 -right-0.5 text-white text-xs rounded-full px-1.5 py-0.5 min-w-[18px] text-center"
